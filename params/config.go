...
var (
    ...
    MainnetChainConfig = &ChainConfig{
        ChainID:             big.NewInt(321), // Custom chain ID
        ...
        CVE_2021_39137Block: big.NewInt(2509228), // Example value, change as needed
        IshikariBlock:       big.NewInt(11171299), // Example value, change as needed
        IshikariPatch001Block: big.NewInt(11171299), // Example value, change as needed
        IshikariPatch002Block: big.NewInt(11171299), // Example value, change as needed
        AmazonBlock:         big.NewInt(24766075), // Example value, change as needed
        POSA: &POSAConfig{
            Period: 3,
            Epoch:  100,
    ...
    TestnetChainConfig = &ChainConfig{
        ...
        POSA: &POSAConfig{
            ...
            IshikariAdminMultiSig: common.HexToAddress("0x22e4A5dfFee45CeaBd4d7c45814BfC27dF3776b4"),
        },
    }
